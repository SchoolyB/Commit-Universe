"""
Go generator - Universe constants
"""

def generate_constants_go(seed: int, cosmic_age: float = 0) -> str:
    """Generate the constants.go file"""
    return f'''package universe
...
const (
    ...
    // Universe parameters
    UniverseSeed       int64   = {seed}          // RNG seed for this timeline
...
var (
    CosmicAgeMyr float64 = {cosmic_age}  // Millions of years since Big Bang
)
'''
